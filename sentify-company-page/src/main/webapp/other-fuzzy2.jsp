...
<body class="">
	...
	<div id="page-wrapper" class="page-wrapper">
		...
		<div id="header" class="header">
			...
			<div id="header-inner">
				...
				<h1 class="page-title">Other categories - Sentify Portal</h1>
			...
			<div class="main-inner">
						...
						<ul class="menu">
							...
							<li><a href="/world">Regions</a>
								<ul>
									...
									<li><a href="/countries?so=${so}">Crisp Sentiment</a></li>
							...
							<li class="active"><a href="/other?so=${so}">Other</a>
								<ul>
									<li><a href="/other?so=${so}">Crisp Sentiment</a></li>
									<li class="active"><a href="/other-fuzzy?so=${so}">Fuzzy Sentiment</a></li>
								</ul></li>
						</ul>			
					</div>
				</div>
				...
				<div id="region-sidebar" class="region region-sidebar">
					<div class="inner">
						...
						<div class="block" id="about">
				            <h2>About Fuzzy Sentiment</h2>

							<p>
							This page presents sentiment for the company of choice, related only to the reputation indicator.
	...
	<script src="js/app-script-fuzzy-vol.js"></script>
