...
<script language='javascript' src='/document-sentiments/VAADIN/widgetsets/eu.first.documentsentiments.RefresherApplicationWidgetset/eu.first.documentsentiments.RefresherApplicationWidgetset.nocache.js?1349375844985'></script>
</head>
    ...
    <div class="main-inner">
      <div id="main-content" class="main-content">
        <div class="inner">
          ...
          <div class="block">
				...
				<iframe width="100%" height="1000px" frameborder="0" allowtransparency="true" src="http://first.ijs.si/demos/TweeterSentimentDemo/" name="PID5" style="overflow: hidden;"></iframe>
      ...
      <div id="navigation">
        <ul class="menu" id="main-menu">
          ...
          <li><a href="./twitter" class="active">Twitter Sentiments</a></li>
        </ul>
      </div>
