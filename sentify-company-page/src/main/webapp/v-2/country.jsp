 ...
 <script src="js/vis-test/jquery-1.8.3.min.js"></script>
							...
							(function($){ // encapsulate jQuery
								...
								$(function () {
									...
									var names = [{'url': '${country.URIFragment}', 'name': '${country.name} sentiment'}],
									...
									$.getJSON('./timeserievolume?so=${country.URIFragment}&enddate='+todayDate+'&callback=?',	function(data) {
									...
									function createChart() {
								        ...
								        $('#container').highcharts({
							                ...
							                subtitle: {
								                text: 'aggregated sentiment, moving average',
								                x: -20
								            },
