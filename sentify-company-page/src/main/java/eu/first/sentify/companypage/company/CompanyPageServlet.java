package eu.first.sentify.companypage.company;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (request.getParameter("so") == null) {
			...
			if (company != null) {
				...
				String targetPage = "company.jsp";
				
				if (servletMode.endsWith("/company") == true) {
					targetPage = "company.jsp";
				}
				if (servletMode.endsWith("/company-fuzzy") == true) {
					targetPage = "company-fuzzy.jsp";
				}
				if (servletMode.endsWith("/company-fuzzy2") == true) {
					targetPage = "company-fuzzy2.jsp";
				}
